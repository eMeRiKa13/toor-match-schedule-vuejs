            ...
            <div class="min-w-full divide-y divide-gray-200">
                ...
                <form class="p-4" @submit.prevent="onSubmit">
                    ...
                    <div class="my-4 text-center">
                        <button type="submit" class="py-2 px-6 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                            Import Matches
                        </button>
                    </div>
                </form>
